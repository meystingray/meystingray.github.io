...
```{r Build training set, echo=TRUE,eval=TRUE}
...
|                                      |                                      |                                       |
|--------------------------------------|--------------------------------------|---------------------------------------|
| ![](images/1128-01.png){width="280"} | ![](images/3926-01.png){width="280"} | ![](images/4699-01.png)               |
| ![](images/7981-01.png){width="280"} | ![](images/8327-01.png){width="280"} | ![](images/10817-01.png){width="280"} |
...
|                                    |                                    |                                         |
|------------------------------------|------------------------------------|-----------------------------------------|
| ![](images/1853.png){width="280"}  | ![](images/5263.png){width="280"}  | ![](images/6326.png){width="280"}       |
| ![](images/6532.png){width="280"}  | ![](images/9558.png){width="280"}  | ![](images/11724.png){width="280"}      |
| ![](images/13728.png){width="280"} | ![](images/17363.png){width="280"} | ![]()![](images/18339.png){width="280"} |
...
|                                  |                                  |                                  |
|----------------------------------|----------------------------------|----------------------------------|
| ![](images/191.png){width="280"} | ![](images/235.png){width="280"} | ![](images/264.png){width="280"} |
| ![](images/273.png){width="280"} | ![](images/392.png){width="280"} | ![](images/418.png){width="280"} |
| ![](images/618.png){width="280"} | ![](images/672.png){width="280"} | ![](images/710.png){width="280"} |
...
![](images/Slope1Regression-02.png){width="200"}
...
|                                  |                                       |                                  |
|----------------------------------|---------------------------------------|----------------------------------|
| ![](images/77.png){width="280"}  | ![](images/90.png){width="280"}       | ![](images/285.png){width="280"} |
| ![](images/324.png){width="280"} | ![](images/345.png){width="280"}      | ![](images/459.png){width="280"} |
| ![](images/677.png){width="280"} | ![]()![](images/777.png){width="280"} | ![](images/810.png){width="280"} |
