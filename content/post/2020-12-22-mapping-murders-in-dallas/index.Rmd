...
DallasMapZoom11 <- get_map(location = "Dallas", zoom = 11, source = "google")
...
ggmap(DallasMapZoom11,extent = "device") + 
    geom_point(data = Murder[Date > as.Date("2020-01-01"),], aes(x = Longitude, y = Latitude), 
...
p <- ggmap(DallasMapZoom11,extent = "normal") +
    geom_point(data = Murder, aes(x = Longitude, y = Latitude,group = seq_along(servyr)), size = 1)
