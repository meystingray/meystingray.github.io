...
To explore the Dallas Crime data more yourself, check out [my Shiny app here](https://sean-conroy.shinyapps.io/shinycrimeexplorer/){target="_blank"}.
...
The interactive Dygraph, using the Dyr
```{r dyplot,echo = FALSE}
